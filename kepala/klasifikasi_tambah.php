            ...
            <form class="form-horizontal" action="klasifikasi_tambah.php" method="post" role="form">
                <div class="panel panel-default">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                             <select name='id_mhs' data-placeholder="Pilih Mahasiswa...." class="required select">
                                <option></option>";
                                <?php
                                $query = "SELECT * FROM calonbeasiswa  order by id_mhs asc";
                                $hasil = mysql_query($query);
                                while ($data = mysql_fetch_array($hasil)) 
                                {
                                    echo "<option value='".$data['id_mhs']."'> ".$data['id_mhs']." - ".$data['nama_mhs']."</option>";
                                }
                                ?>
                            </select>
                        </div>
...
if (isset($_POST['simpan'])) {
    ...
    ('','$id_mhs','$keterangan_miskin','$nilai_ipk','$penghasilan_ortu','$semester','$usia')";
