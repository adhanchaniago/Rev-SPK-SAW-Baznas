                ...
                <ul class="nav navbar-nav navbar-left-custom">
                    <li class="user dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span>Seleksi Pemberian Zakat Metode SAW</span>
						...
						<div class="panel-body">
                            ...
                            <div class="form-group has-feedback" align="left">
								<label>Level</label> <br />
								 <select name='level' class="form-control" data-placeholder="Pilih Level...." class="required select">
                                <option value="#"></option>
                                <option value="1">Administrator</option>
                                <option value="2">Kepala Baznas</option>
