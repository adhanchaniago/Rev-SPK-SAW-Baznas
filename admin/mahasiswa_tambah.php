...
<div id="content">
	...
	<form class="form-horizontal" action="mahasiswa_tambah.php" method="post" role="form">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h6 class="panel-title">Calon Penerima Beasiswa</h6>
			</div>
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="number" name="nik_mhs" class="form-control" required>
					</div>
				</div>
	...
	('$nik_mhs','$nama_mhs','$jenis_kelamin','$tempat_lahir','$tanggal_lahir','$perguruan_tinggi','$alamat','$nagari','$kecamatan')";
